...
<body class="bg-[#eff6ff] text-[#1e40af] font-sans min-h-screen flex flex-col">
  <header class="bg-[#1e3a8a] text-white flex justify-between items-center px-6 py-4 shadow-md">
    ...
    <nav class="space-x-6">
      <a href="#" class="hover:underline hover:text-[#bfdbfe] font-semibold">Dashboard</a>
      <a href="#" class="hover:underline hover:text-[#bfdbfe] font-semibold">Pengiriman</a>
      <a href="#" class="hover:underline hover:text-[#bfdbfe] font-semibold">Laporan</a>
      <a href="#" class="hover:underline hover:text-[#bfdbfe] font-semibold">Akun</a>
    </nav>
  </header>
